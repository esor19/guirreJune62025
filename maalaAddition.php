...
<body>
<h1> Addition</h1>
<form action="maalaAddition.php" method="POST">
	<h2>
	<table>
	<tr>
	...
	if(isset($_POST['compute'])){
			...
			$maala_Sum = $maala_FirstNumber + $maala_SecondNumber; echo $maala_Sum;
	
			$compute = mysqli_query ($maala_Connection,"INSERT INTO maalaAddition(maala_FirstNumber,
			maala_SecondNumber, maala_Sum) VALUES ('$maala_FirstNumber', '$maala_SecondNumber', 
			'$maala_Sum')");
	}
	?>">
	</td>
