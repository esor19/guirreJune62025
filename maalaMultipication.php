...
<form method="POST">
	...
	if(isset($_POST['compute'])){
			...
			$maala_Product = $maala_FirstNumber * $maala_SecondNumber; echo $maala_Product;
	
			$compute = mysqli_query ($maala_Connection,"INSERT INTO maalaMultiplication(maala_FirstNumber,
			maala_SecondNumber, maala_Product) VALUES ('$maala_FirstNumber', '$maala_SecondNumber', 
			'$maala_Product')");
	}
	?>">
	</td>
