...
<form method="POST">
	...
	if(isset($_POST['compute'])){
			...
			$maala_Quotient = $maala_FirstNumber / $maala_SecondNumber; echo $maala_Quotient;
	
			$compute = mysqli_query ($maala_Connection,"INSERT INTO maalaDivision(maala_FirstNumber,
			maala_SecondNumber, maala_Quotient) VALUES ('$maala_FirstNumber', '$maala_SecondNumber', 
			'$maala_Quotient')");
	}
	?>">
	</td>
